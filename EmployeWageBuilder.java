	...
	public static void main(String[] args) {
		...
		wageBuilder(empHrs, empWage, totalWage, totalWorkingDays, totalEmpHrs);
	}

	static void wageBuilder(int empHrs, int empWage, int totalWage, int totalWorkingDays, int totalEmpHrs) {
